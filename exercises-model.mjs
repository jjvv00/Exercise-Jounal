...
const readExercises = async (allExercises) => {
    const query = Exercise.find(allExercises);
    return query.exec();
}

// Retrieve based on the ID and return a promise.
const findExerciseByID = async (_id) => {
    const query = Exercise.findExerciseByID(_id);
    return query.exec();
}
...
export { createExercise, readExercises, findExerciseByID, updateExercise, deleteByID }